...
| Daily Deliveries | Review/post one household delivery sheet | owner, manager, delivery | delivery service | delivery batches, customer deliveries, inventory, party ledger, financial, notifications, audit | batch receipt or exception error | delivery contract/calculation tests | Complete |
...
| Expenses | Draft/edit/post/reverse/attachment/export | owner, manager, accountant | expense service/upload handler | expenses, cashbook, financial, audit | receipt or validation/upload error | expense E2E | Pending |
...
| Reports | Filter/export/download/print | owner, manager, accountant | report/export handlers | authoritative ledgers | reconciled file or query error | export integration | Pending |
